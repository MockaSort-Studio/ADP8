...
class ActuationInterfaceNode : public sert::core::TaskInterface {
 public:
  ActuationInterfaceNode(const std::string& name, rclcpp::NodeOptions options)
      : TaskInterface(name, options.append_parameter_override(
    ...
    RegisterSubscriber<car_msgs::msg::CarControl>(
        "car_cmd", [this](car_msgs::msg::CarControl::UniquePtr msg) {
          ctrl_msg_ = *msg;
          ctrl_received_ = true;
        });
  }
...
using ActuationInterfaceNodeConfig =
    sert::support::LookupTable<sert::support::TableItem<
        ActuationInterfaceNode, sert::support::UnusedValue>>;

int main(int argc, char* argv[]) {
  rclcpp::init(argc, argv);
  auto task_manager =
      sert::core::BuildTasksManager<ActuationInterfaceNodeConfig>();
