...
class BenchTask
    : public core::lifecycle::DDSTask<core::lifecycle::TestTopicSubsList,
                                      core::lifecycle::TestTopicPubsList> {
 public:
  using core::lifecycle::DDSTask<core::lifecycle::TestTopicSubsList,
